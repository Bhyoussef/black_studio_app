              ...
              Row(
                children: [
                  GestureDetector(
                    ...
                    child: Stack(
                      children: [
                        Image.asset('assets/icons/rectangle.png',width: 100,),
                        const Positioned(
                            left: 30,
                            top: 30,
                  ...
                  _selectedImages.isEmpty?
                      const Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("Upload Images",style: TextStyle(fontSize: 23,color: AppColor.primaryBlackColor)),
                            SizedBox(height: 10),
                            Text("Upload Png,jpg(max 15mb)",style: TextStyle(fontSize: 18,color: AppColor.secondaryBlackColor)),
                          ],
                        ),
                      )
                      :
